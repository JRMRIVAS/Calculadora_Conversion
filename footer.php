...
<body>
    <footer class="fixed-bottom bg-secondary text-center hola">
        <div class="my-3 d-flex justify-content-center align-items-center">
            <a href="http://www.google.com" target="_blank" class="link-decoration-none">
            ...
            <div class="text-white mx-5  ">
                <p class="mb-0 fs-5">Diseñado por</p>
                <p class="mb-0">Rodrigo Rivas</p>
            </div>
